...
### Runtime Layer
- **30 Agents** — Role-based subagents with tool restrictions
- **93 Skills** — Workflow automations (slash commands)
- **11 Rules** — Path-scoped coding constraints
- **44 Hooks** — Pre/Post tool-use automation (25 root + 19 template)
