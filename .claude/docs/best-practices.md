...
## CLAUDE.md
- Max 150 lines root (hard limit 200), 80 per module, 50 per rule (all rules respect this)
...
- 30 agents required: 4 SDLC roles + 6 core + 4 dev + 4 pre-dev + 5 governance + 4 specialist + 3 Phase 12
- SDLC roles: team-lead, architect, product-owner, qa-lead
- Core: explorer, reviewer, security, debugger, tester, code-quality
- Dev (conditional): frontend, api-builder, infra, mobile
- Pre-dev: ideator, strategist, scaffolder, ux-designer
- Governance: cto, gatekeeper, output-validator, process-coach, docs-writer
- Specialist: database, qa-automation, analyst, version-manager
- Phase 12 (monitoring/maintenance): observability-engineer, incident-responder, performance-engineer
